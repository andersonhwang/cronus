    ...
    public sealed class TagEntity
    {
        ...
        internal byte ParttenCode
        {
            get
            {
                switch (Pattern)
                {
                    case Pattern.PreOTA: return 0x3F;
        ...
        {
            List<byte> lst = new List<byte> { ParttenCode };
            ...
            else
            {
                ...
                {
                    lst.Add(0x0D);
                    lst.AddRange(PB.HB(NewKey.Substring(0, 6)));
                    lst.Add(0x00);
                    lst.Add(0xF7);
                    lst.AddRange(PB.HB(NewKey[6..]));
                }
